      ...
      <div className="max-w-2xl mx-auto space-y-12">
        ...
        <div className="grid gap-6">
          <Link to="/greetings" className="transform transition-transform hover:scale-105">
            <Button 
              className="w-full h-20 text-xl bg-gradient-to-r from-[#FEC6A1] to-[#F97316] hover:from-[#F97316] hover:to-[#FEC6A1] border-none shadow-lg"
            >
          ...
          <Link to="/letter-matching" className="transform transition-transform hover:scale-105">
            <Button 
              className="w-full h-20 text-xl bg-gradient-to-r from-[#9b87f5] to-[#E5DEFF] hover:from-[#E5DEFF] hover:to-[#9b87f5] border-none shadow-lg"
            >
          ...
          <Link to="/flashcards" className="transform transition-transform hover:scale-105">
            <Button 
              className="w-full h-20 text-xl bg-gradient-to-r from-[#F2FCE2] to-[#c1c161] hover:from-[#c1c161] hover:to-[#F2FCE2] border-none shadow-lg"
            >
          ...
          <Link to="/word-search" className="transform transition-transform hover:scale-105">
            <Button 
              className="w-full h-20 text-xl bg-gradient-to-r from-[#D3E4FD] to-[#0EA5E9] hover:from-[#0EA5E9] hover:to-[#D3E4FD] border-none shadow-lg"
            >
          ...
          <Link to="/hangman" className="transform transition-transform hover:scale-105">
            <Button 
              className="w-full h-20 text-xl bg-gradient-to-r from-[#FFDEE2] to-[#d299c2] hover:from-[#d299c2] hover:to-[#FFDEE2] border-none shadow-lg"
            >
          ...
          <Link to="/multiple-choice" className="transform transition-transform hover:scale-105">
            <Button 
              className="w-full h-20 text-xl bg-gradient-to-r from-[#FEF7CD] to-[#e6b980] hover:from-[#e6b980] hover:to-[#FEF7CD] border-none shadow-lg"
            >
          ...
          <Link to="/sentence-builder" className="transform transition-transform hover:scale-105">
            <Button 
              className="w-full h-20 text-xl bg-gradient-to-r from-[#accbee] to-[#e7f0fd] hover:from-[#e7f0fd] hover:to-[#accbee] border-none shadow-lg"
            >
